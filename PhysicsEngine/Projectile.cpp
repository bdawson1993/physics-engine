...
void Projectile::CreateDynamic(PxVec3 pos, PxVec3 size, PxMaterial* mat)
{
	...
	CreateShape(PxBoxGeometry(0.5f, 0.5f, 0.5f), *mat, 5, pos);
	CreateShape(PxBoxGeometry(1.0f, 1.0f, 1.0f), *mat, 5, pos + PxVec3(0, pos.y + 0.5f, 0));
	CreateShape(PxBoxGeometry(0.5f, 0.5f, 0.5f), *mat, 5, pos + PxVec3(0, pos.y + 2.0f, 0));
	SetName();
}
